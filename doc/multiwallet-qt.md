...
In order to support loading of multiple wallets in bulpcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bulpcoin.cpp.
...
Changes to bulpcoin.cpp
----------------------
bulpcoin.cpp is the entry point into bulpcoin-qt, and as such, will require some minor modifications to provide hooks for
