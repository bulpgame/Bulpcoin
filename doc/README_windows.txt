...
Intro
-----
Bulpcoin (BULP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Bulpcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bulpcoin-qt.exe.

Bulpcoin Core is the original Bulpcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Bulpcoin transactions;
