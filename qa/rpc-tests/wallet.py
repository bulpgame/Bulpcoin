...
#   c) node1 mines 32 blocks, so now node 0 has 500000BULP, node 1 has 4250BULP, node2 has none.
#   d) node0 sends 601 BULP to node2, in two transactions (301 BULP, then 300 BULP).
