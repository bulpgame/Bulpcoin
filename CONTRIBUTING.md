Contributing to Bulpcoin Core
==================================

The Bulpcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bulpcoin Core project, and is not to be
confused with overall Bulpcoin Network Protocol consensus changes.

Whether a pull request is merged into Bulpcoin Core rests with the project merge
...
Patches that change Bulpcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bulpcoin consensus, it must have been
...
The project leader is the release manager for each Bulpcoin Core release.
