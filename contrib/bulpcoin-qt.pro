...
RESOURCES += src/qt/bulpcoin.qrc src/qt/bulpcoin_locale.qrc

TRANSLATIONS += src/qt/locale/bulpcoin_bg.ts \
                src/qt/locale/bulpcoin_de.ts \
                src/qt/locale/bulpcoin_en.ts \
                src/qt/locale/bulpcoin_es.ts \
                src/qt/locale/bulpcoin_fi.ts \
                src/qt/locale/bulpcoin_fr.ts \
                src/qt/locale/bulpcoin_it.ts \
                src/qt/locale/bulpcoin_ja.ts \
                src/qt/locale/bulpcoin_pl.ts \
                src/qt/locale/bulpcoin_pt.ts \
                src/qt/locale/bulpcoin_ru.ts \
                src/qt/locale/bulpcoin_sk.ts \
                src/qt/locale/bulpcoin_sv.ts \
                src/qt/locale/bulpcoin_vi.ts \
                src/qt/locale/bulpcoin_zh_CN.ts \
                src/qt/locale/bulpcoin_zh_TW.ts
