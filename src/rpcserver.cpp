...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bulpcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Bulpcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bulpcoin features */
        {"bulpcoin", "masternode", &masternode, true, true, false},
        {"bulpcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bulpcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bulpcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bulpcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bulpcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bulpcoin", "startmasternode", &startmasternode, true, true, false},
        {"bulpcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bulpcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bulpcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bulpcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bulpcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bulpcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bulpcoin", "mnbudget", &mnbudget, true, true, false},
        {"bulpcoin", "preparebudget", &preparebudget, true, true, false},
        {"bulpcoin", "submitbudget", &submitbudget, true, true, false},
        {"bulpcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bulpcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bulpcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bulpcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bulpcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bulpcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bulpcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bulpcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bulpcoin", "mnsync", &mnsync, true, true, false},
        {"bulpcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> bulpcoin-cli " + methodname + " " + args + "\n";
}
