...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bulpcoin Core"),
     ...
     * override -datadir in the bulpcoin.conf file in the default data directory
     * (to be consistent with bulpcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
