...
/** Utility functions used by the Bulpcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BULP addresses in monospace font
...
// Parse "bulpcoin:" URI into recipient object, return true on successful parsing
