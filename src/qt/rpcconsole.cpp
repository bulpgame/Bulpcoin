...
// Repair parameters
const QString BULPCOINWALLET("-bulpcoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_bulpcoinwallet, SIGNAL(clicked()), this, SLOT(walletBulpcoin()));
...
/** Restart wallet with "-bulpcoinwallet" */
void RPCConsole::walletBulpcoin()
{
    buildParameterlist(BULPCOINWALLET);
}
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bulpcoin RPC console.") + "<br>" +
