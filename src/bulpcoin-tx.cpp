...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bulpcoin Core bulpcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bulpcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bulpcoin transaction") + "\n" +
                               "  bulpcoin-tx [options] -create [commands]   " + _("Create hex-encoded bulpcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bulpcoin transaction
